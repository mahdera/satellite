...
<body>
	<div id="content-wrapper"> 
		...
		<div id="container"> 
			<!-- Header begin-->
			<?php
                            include_once 'ad_page_sections/admin_index_header.php';
                        ?>
			<!-- Header end --> 
			<!-- slide start -->
			<?php
			...
			<div id="main" class="round_8 clearfix mobile-collapse">
                                <!--home content start-->
                                <?php
                                    include_once 'ad_page_sections/admin_index_home_content.php';
                                ?>				
                                <!--home content end-->                               
			</div>
			<!-- Main end --> 
			<!-- Footer begin -->
			<?php
                            include_once 'ad_page_sections/admin_index_footer.php';
                        ?>
			<!-- Footer end --> 
	...
	<!--put the javascript import statements in here...-->
            <?php
                include_once 'ad_page_sections/admin_javascript_imports.php';
            ?>
