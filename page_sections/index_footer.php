<div id="footer" class="round_8 clearfix">
    ...
    <div class="col_201">
        ...
        <address>
            BSO Jungkidz
            3401 RB IJSSELSTEIN<br/>
            Panoven 60<br/>
            Nederland<br/>
            Tel: 030-68 87 824<br/>
            Email: administratie@bso-jungkidz.nl
        </address>
    ...
    <div id="footer-bottom"> <div id="toTop" class="left">Back to Top</div>
        <div id="footer-note" class="right">
            <small>
                ©2011 Theme by <strong>Population 2</strong>, designed for <strong>Themeforest</strong>. Protected by <strong>Copyscape</strong>
            </small>
        </div>
    </div>
</div>